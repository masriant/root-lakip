    ...
    <div class="row">
        <div class="col-8">
            ...
            <form action="/materi/update/<?= $materi['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="sampulLama" value="<?= $materi['sampul']; ?>">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="penulis" name="penulis" value="<?= (old('penulis')) ? old('penulis') : $materi['penulis'] ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="penerbit" name="penerbit" value="<?= (old('penerbit')) ? old('penerbit') : $materi['penerbit'] ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-2">
                        <img src="/images/<?= $materi['sampul']; ?>" class="img-thumbnail img-preview">
                    </div>
                    <div class="col-sm-8">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="Sampul"><?= $materi['sampul']; ?></label>
                        </div>
                    </div>
                </div>
